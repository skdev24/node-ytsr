...
exports.buildLink = (query, gl = 'US', hl = 'en') => BASE_URL + QUERYSTRING
  .encode({
    search_query: query,
    spf: 'navigate',
    gl,
...
exports.buildFromNextpage = (nextpageRef, gl = 'US', hl = 'en') => {
...
exports.parseChannel = string => {
  ...
  return {
    ...
    videos: Number(
      exports.between(string, '<ul class="yt-lockup-meta-info"><li>', '</li>')
        .split(' ')
        .splice(0, 1)[0]
        .replace(/[.,]/g, ''),
    ),
...
exports.parseVideo = string => {
  ...
  return {
    ...
    views: live ? live_views : ( // eslint-disable-line no-extra-parens
...
exports.parseFilters = body => {
  ...
  const columns = filterContainer.split('<h4 class="filter-col-title">').splice(1);
